...
class TransitInterpreter:
    ...
    def interpret_transits(context: NormalizedChartContext) -> List[Dict[str, Any]]:
        ...
        # 1. 2026 Saturn Transit (కుంభం నుండి మీన రాశి)
        saturn_text = f"2026 శని గోచారం (మీన రాశి ప్రవేశం): మీ {lagna} లగ్నమునకు శని గోచార ప్రభావం కర్మఫలదాతగా పనిచేస్తుంది."
        ...
        jupiter_text = f"2026 గురు గోచారం (కర్కాటక రాశిలో ఉచ్చ స్థితి): గురు భగవానుని అనుగ్రహం లభిస్తుంది."
